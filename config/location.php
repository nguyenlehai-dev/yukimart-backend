...
return [
    ...
    */
    ...
    // MaxMind offline: dùng file .mmdb local, không cần mạng. Chạy `sail artisan location:update` sau khi cấu hình MAXMIND_LICENSE_KEY.
    ...
    |--------------------------------------------------------------------------
    |
    | Dùng offline: để trống fallbacks. Có thể thêm driver online (IpApi, GeoPlugin...)
    | để dự phòng khi MaxMind local thất bại.
    |
    */
    ...
    */
    ...
    // Tắt testing để lấy IP thật từ request (dùng cho LogActivity).
    'testing' => [
        'ip' => '66.102.0.0',
