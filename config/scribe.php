...
return [
    ...
    'description' => 'Hailn Core API - RESTful API cho quản lý xác thực (Auth), người dùng (User) và bài viết (Post). Sử dụng Laravel Sanctum để xác thực Bearer token.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            Tài liệu này cung cấp thông tin chi tiết để tích hợp và sử dụng Hailn Core API.
